...
| `* *`    | new user                                  | delete the example candidates all at once   | I can easily start using the app                                     |
| `* *`    | user stop using the app | clear the existing candidates all at once   | I can delete the confidential information with facile |
