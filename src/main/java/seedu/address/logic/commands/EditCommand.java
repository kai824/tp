...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor)
        ...
        if (removedTags != null) {
            Set<Tag> tagsWillRemove = new HashSet<>(removedTags);
            tagsWillRemove.removeAll(personToEdit.getTags());
            if (!tagsWillRemove.isEmpty()) {
                throw new CommandException(String.format(MESSAGE_TAG_DOES_NOT_EXIST, tagsWillRemove.iterator().next()));
            }
